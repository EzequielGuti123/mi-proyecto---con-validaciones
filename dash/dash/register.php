...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
                        ...
                        <div class="col-lg-7">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Alta de Clientes</h1>
                                </div>
                                <form class="user" action="alta_clientes.php" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control form-control-user" name="celular" placeholder="Celular">
            </div>
        </div>
        <button type="submit" class="btn btn-primary btn-user btn-block">Registrar Cliente</button>
    </form>
